...
M11 = I1o + I2o + I3o + L1*L2*(m2+2*m3)*cos(q2) + 2*L2*(L3-c3x)*m3*cos(q3) + 2*L1*(L3-c3x)*m3*cos(q2+q3) + 2*L1*c3y*m3*sin(q2+q3) + 2*L2*c3y*m3*sin(q3);
M12 = I2o + I3o + .5*L1*L2*(m2+2*m3)*cos(q2) + 2*L2*(L3-c3x)*m3*cos(q3) + L1*(L3-c3x)*m3*cos(q2+q3) + L1*c3y*m3*sin(q2+q3) + L2*c3y*m3*sin(q3);
