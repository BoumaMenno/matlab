function AnimRef(time,q,showpath,filename)
...
for ii = 1:length(t)
    ...
    hold on
    if showpath == 1
        plot(x(1:ii),y(1:ii),'color',tue.r,'linewidth',2)
        plot(x(1),y(1),'.','color',tue.r,'markersize',18)
    end
...
%     
    ...
    if showpath == 1
        plot(x(ii),y(ii),'.','color',tue.r,'markersize',22)
    end
