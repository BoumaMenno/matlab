...
y{1}  = [0.65, 0,       0; 
         0.4,  Dy-w4/2, pi/2;
         0.35, 1.45*Dy, 2*pi/3];    % Position and orientation of the end-effector at beginning, impact, and end of (extended) phase 1
...
a{1}  = zeros(3,3);                 % (Trans. and rot.) acceleration of the end-effector at beginning, impact, and end of (extended) phase 1
% a{1}(2,2) = 3;
